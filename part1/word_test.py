...
class WordTestWindow:
    ...
    def multi_choice_question(self):
        ...
        self.buttons = []
        for i in range(4):
            btn = customtkinter.CTkButton(self.window, width=200, height=50, text=f"{i+1}번",
                                          command=lambda idx=i: self.check_answer(idx),
                                          bg_color=self.bgColor, fg_color=self.fgColor, hover_color=self.hoverColor,
    ...
    def short_answer_question(self):
        ...
        self.entry = customtkinter.CTkEntry(self.window, width=200, fg_color=self.bgColor, border_color=self.fgColor,
                                            text_color="black", corner_radius=0)
        self.entry.pack(pady=7)

        self.check_btn = customtkinter.CTkButton(self.window, text="확인", width=150, height=50,
                                                 bg_color=self.bgColor, fg_color=self.fgColor, hover_color=self.hoverColor,
                                                 corner_radius=32, text_color="white", font=("맑은 고딕", 16, "bold"),
                                                 command=self.check_short_answer)
        self.check_btn.pack()
    ...
    def show_result(self):
        ...
        close_button = customtkinter.CTkButton(self.window, text="닫기", width=30, height=20, command=self.window.destroy,
                                               bg_color=self.bgColor, fg_color=self.fgColor, hover_color=self.hoverColor)
    ...
    def open_wordtest_window(self):
        ...
        level_text = customtkinter.CTkLabel(self.window, text="사용자의 수준을 알아보기 위해 단어 테스트를 진행하겠습니다.",
                                            text_color="black", bg_color=self.bgColor, font=("맑은 고딕", 13))
        level_text.pack(pady=30)

        self.question_label = customtkinter.CTkLabel(self.window, width=30, height=4, text="test",
                                                     text_color="black", font=("맑은 고딕", 20, "bold"), bg_color=self.bgColor)
        self.question_label.pack(pady=10)

        self.progress_label = customtkinter.CTkLabel(self.window, text=f"{self.current_question}/{self.total_questions}",
                                                     font=("맑은 고딕", 12), text_color="black", bg_color=self.bgColor)
