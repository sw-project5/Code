...
#     title_label = tkinter.Label(description_window, text="TOEICVOCAMACA", width=20, height=2, font=font)
#     title_label.pack()



#     # 단어장 설명 창 내용 추가
#     description_label2 = tkinter.Label(description_window, text="단어장 설명 페이지입니다.\n안녕하세요")
#     description_label2.place(relx=0.5, rely=0.2, anchor=tkinter.CENTER)
...
#         "안녕하세요!",
#         "어떤 토익단어장인가요?",
#         "주 사용자인 대학생을 위해 토익 영단어를 쉽게 외울 수 있도록 토익 단어 및 학습 기능을 제공합니다!",
#         "다른 영단어장과의 차이점이 있나요?",
#         "각종 테스트 및 레벨 시스템을 도입한 재밌는 영단어장입니다.",
#         "레벨은 어떻게 구성되어있나요?",
#         "처음 회원가입 시 레벨은 '아이언'이고, '브론즈'~'플레티넘'레벨이 있습니다."
#     ]

#     # 각 메시지에 대한 라벨 생성 및 배치
#     for i, message in enumerate(messages):
#         label = tkinter.Label(description_window, text=message, font=font)
#         label.place(relx=0.5, rely=0.2 + i * 0.1, anchor=tkinter.CENTER)
