...
# 로그인 버튼
button_login=customtkinter.CTkButton(master=window,text="로그인", bg_color=bgColor,fg_color=fgColor,hover_color=hoverColor,corner_radius=32, command=lambda:open_login_window(window))
button_login.place(relx=0.5,rely=0.5,anchor="center")


# 단어장 설명 버튼
button_description=customtkinter.CTkButton(master=window, text="단어장 설명",bg_color=bgColor,fg_color=fgColor,hover_color=hoverColor,corner_radius=32, command=lambda:open_description_window(window))
