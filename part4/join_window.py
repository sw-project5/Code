...
def open_join_window(window):
    ...
    username_entry = customtkinter.CTkEntry(join_window, placeholder_text="영어로 입력하세요",placeholder_text_color="#964B64",text_color="black",fg_color=bgColor,border_color=fgColor)
    ...
    password_entry = customtkinter.CTkEntry(join_window, text_color="black",fg_color=bgColor,border_color=fgColor,show="*")
    ...
    confirm_password_entry = customtkinter.CTkEntry(join_window,text_color="black",fg_color=bgColor,border_color=fgColor, show="*")
    ...
    birthday_entry = customtkinter.CTkEntry(join_window,text_color="black",fg_color=bgColor,border_color=fgColor)
