...
def open_password_reset_window():
    try:
        ...
        username_entry = customtkinter.CTkEntry(password_reset_window, corner_radius=0,text_color="black", fg_color=bgColor, border_color=fgColor)
        ...
        birthday_entry = customtkinter.CTkEntry(password_reset_window, corner_radius=0, text_color="black",fg_color=bgColor, border_color=fgColor)
        ...
        # 창 순서 조정 코드 추가
        password_reset_window.attributes("-topmost", True)
        password_reset_window.after(100, lambda: password_reset_window.attributes("-topmost", False))
